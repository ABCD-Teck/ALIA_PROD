...
const pool = new Pool({
  ...
  database: process.env.PGDATABASE_MIA, // Using MIA database
...
async function investigateMiaDatabase() {
  try {
    console.log('=== INVESTIGATING MIA_INSIGHTS DATABASE ===\n');
    console.log(`Host: ${process.env.PGHOST}`);
    console.log(`Database: ${process.env.PGDATABASE_MIA}\n`);
    ...
    console.log('=== TABLES IN MIA_INSIGHTS DATABASE ===');
